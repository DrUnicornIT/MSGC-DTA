...
def train_predict(): 
    ...
    d_1d_embeds = np.load('/root/MSGC-DTA/data/results/unique_drug_Mol2Vec_EMB_KIBA.npy')
    d_2d_embeds = np.load('/root/MSGC-DTA/data/results/unique_drug_GIN_EMB_KIBA.npy')
    d_3d_embeds = np.load('/root/MSGC-DTA/data/results/unique_drug_E3nn_EMB_KIBA.npy')
    
    t_1d_embeds = np.load('/root/MSGC-DTA/data/results/unique_protein_ProVec_EMB_KIBA.npy') 
    t_2d_embeds = np.load('/root/MSGC-DTA/data/results/unique_protein_BERT_EMB_KIBA.npy')
    t_3d_embeds = np.load('/root/MSGC-DTA/data/results/unique_protein_ESM_EMB_KIBA.npy')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--workspace', type=str, default='/root/code/MSGC-DTA')
    parser.add_argument('--dataset', type=str, default='kiba')
    parser.add_argument('--epochs', type=int, default=3000)    # --kiba 3000
