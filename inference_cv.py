...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load("checkpoint/kiba_sota_main_cv.pth", map_location=torch.device('cpu')))
    predictor.load_state_dict(torch.load("checkpoint/kiba_sota_predictor_cv.pth", map_location=torch.device('cpu')))
