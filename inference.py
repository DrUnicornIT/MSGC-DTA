...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load("kiba_sota_main.pth", map_location=torch.device('cpu')))
    predictor.load_state_dict(torch.load("kiba_sota_predictor.pth", map_location=torch.device('cpu')))
